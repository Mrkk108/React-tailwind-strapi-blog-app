  ...
  return ( 
    <div className='w-full pb-10 bg-[#f9f9f9]'>
        <div className='max-w-[1240px] mx-auto'>
            ...
            md:gap-x-8 sm:gap-y-8 ss:gap-y-8 px-4 sm:pt-20 md:mt-0 ss:pt-20 text-black m-auto'>

                <div className='col-span-2 '>
                    <img className='h-56 w-full object-cover' src={`http://localhost:1337${blog.attributes.coverImg.data.attributes.url}`} />
                    <p className="text-gray-600 text-xl mt-2">{blog.attributes.blogTitle}</p>
                    <h3 className="font-bold text-xl my-1">{blog.attributes.blogDesc}</h3>
